Note: This version of zCompile has been discontinued, however I am working on a new version of zCompile that will be released soon, if there was a link above this then it has been released and ready to use. The reason I am choosing to rewrite this is because the code of the current version has gotton rather clunky and hard to read and mantain and was very windows centered so it was hard to adapt into other targets, although this repo specifically is relatively new the project isnt and has been ongoing elsewhere before it was moved to github for almost a year now, you can still use this version of zCompile as its relatively stable and the new version will be mostly backwards compatable with the current version. I'm writing the new version in go and will probably release it under a different name and I will add more targets, make it perform better, make it easier to read and extend. As of writing this the date is the 14th of July, 2026 and I hope to get it released before august, if you wish to use the current version you can see the documentation below and I will see you in the new version.
